...
import com.michelle.accessibilityservice.MyApplication;
import com.michelle.accessibilityservice.util.Config;
import com.michelle.accessibilityservice.util.DateTimeUtil;
...
public class AccessibilityServiceMonitor extends AccessibilityService {
    ...
    /**
     * 屏幕亮、屏幕灭、屏幕 解锁三个事件我们需要在代码中注册监听ACTION_SCREEN_ON、ACTION_SCREEN_OFF、ACTION_USER_PRESENT三个Action
     */
